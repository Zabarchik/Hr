...
function ModalWindow({ condidate, share, show, setShow, handleClose }) {
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              ...
              <Dropdown>
                ...
                <Dropdown.Menu>
                  ...
                  <Dropdown.Item onClick={() => handleSelect('Интервью')}>Интервью</Dropdown.Item>
